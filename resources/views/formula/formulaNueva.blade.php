...
<div class="box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title">Ingreso de detalle de formula</h3>
	</div><!-- /.box-header -->
	<!-- form start -->
			...
			<div class="col-sm-12">
				...
				<table class="table table-bordered" id="tblProductos">
					...
					<tr>
						...
						<td>
							<input type="number" class="form-control" placeholder="50%" name="nombre">
						</td>
						<td>
							<input type="number" class="form-control" placeholder="10" name="nombre">
						</td>
						<td align="center">
