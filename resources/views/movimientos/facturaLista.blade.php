    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header">
          ...
          <a href="{{ route('facturaIngreso') }}" class="btn btn-lg btn-primary pull-right"><span class="fa fa-plus"></span> Nuevo</a>
        </div><!-- /.box-header -->
        <div class="box-body table-responsive">
          <table id="tablaAlumnos" class="table table-hover">
            ...
            <tbody>
              ...
              <td align="center">
                <a href="{{ route('facturaVer', ['id' => $factura->id]) }}" class="btn btn-info"><span class="fa fa-eye"></span></a>
                <a href="{{ route('facturaVer', ['id' => $factura->id]) }}" class="btn btn-warning"><span class="fa fa-edit"></span></a>
                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalEliminar" data-factura="{{ $factura->id }}" data-id="{{ $factura->id }}">
